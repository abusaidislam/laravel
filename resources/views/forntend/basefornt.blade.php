        ...
        <header id="header" class="header-v3">
                ...
                <div class="tp-banner">
                    <ul>
                        <li data-transition="slidevertical" data-slotamount="1" data-masterspeed="1000"
                            ...
                            <img src="{{ asset('forntend') }}/assets/img/slide/1.jpg" alt="fullslide1"
                        ...
                        <li data-transition="slidehorizontal" data-slotamount="1" data-masterspeed="1000"
                            data-saveperformance="off" data-title="Slide">
                            <img src="{{ asset('forntend') }}/assets/img/slide/2.jpg" alt="fullslide1"
                                data-bgposition="top center" data-kenburns="on" data-duration="6000"
                                data-ease="Linear.easeNone" data-bgfit="130" data-bgfitend="100"
                                data-bgpositionend="right center">
                        </li>
                    </ul>
            ...
            <section class="content-central">
                                ...
                                <ul id="sponsors" class="tooltip-hover">
                                    <li data-toggle="tooltip" title="" data-original-title="AC"> <a
                                            href="servicesbycategory/1.html"><img
                                                src="{{ asset('forntend') }}/images/sercat/service-icon.png"
                                                alt="AC"></a></li>
                ...
                <div class="semiboxshadow text-center">
                    <img src="{{ asset('forntend') }}/assets/img/img-theme/shp.png" class="img-responsive"
                        alt="">
                </div>
                            ...
                            <div class="portfolioContainer" style="margin-top: -50px;">
                                <div class="col-xs-6 col-sm-4 col-md-3 hsgrids"
                                    ...
                                    <a class="g-list" href="service-details/ac-dry-servicing.html">
                                        <div class="img-hover">
                                            <img src="{{ asset('forntend') }}/images/services/thumbnails/thumbnail.jpg"
